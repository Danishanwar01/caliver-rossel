...
<div className="col-12 col-md-auto">
<div className="d-flex align-items-center"><span className="fa-stack" style={{minHeight: "46px", minWidth: "46px"}}><span className="fa-solid fa-square fa-stack-2x dark__text-opacity-50 text-warning-light" data-fa-transform="down-4 rotate--10 left-4"></span><span className="fa-solid fa-circle fa-stack-2x stack-circle text-stats-circle-warning" data-fa-transform="up-4 right-3 grow-2"></span><span className="fa-stack-1x fa-solid fa-pause text-warning" data-fa-transform="shrink-2 up-8 right-6"></span></span>
<div className="ms-3">
...
<div className="col-12 col-md-auto">
<div className="d-flex align-items-center"><span className="fa-stack" style={{minHeight: "46px", minWidth: "46px"}}><span className="fa-solid fa-square fa-stack-2x dark__text-opacity-50 text-danger-light" data-fa-transform="down-4 rotate--10 left-4"></span><span className="fa-solid fa-circle fa-stack-2x stack-circle text-stats-circle-danger" data-fa-transform="up-4 right-3 grow-2"></span><span className="fa-stack-1x fa-solid fa-xmark text-danger" data-fa-transform="shrink-2 up-8 right-6"></span></span>
<div className="ms-3">
...
<div className="col-auto"><button className="btn btn-sm btn-phoenix-secondary bg-body-emphasis bg-body-hover me-2" type="button">All
                    products</button>
<button className="btn btn-sm btn-phoenix-secondary bg-body-emphasis bg-body-hover action-btn" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h" data-fa-transform="shrink-2"></span></button>
...
<th className="sort white-space-nowrap align-middle" scope="col" style={{minWidth: "360px"}} data-sort="product">PRODUCT</th>
<th className="sort align-middle" scope="col" data-sort="customer" style={{minWidth: "200px"}}>CUSTOMER</th>
<th className="sort align-middle" scope="col" data-sort="rating" style={{minWidth: "110px"}}>RATING</th>
<th className="sort align-middle" scope="col" style={{maxWidth: "350px"}} data-sort="review">REVIEW</th>
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/1.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Fitbit Sense Advanced Smartwatch with Tools
                      fo...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<p className="fs-9 fw-semibold text-body-highlight mb-0">This Fitbit is fantastic! I was trying to be in
...
<div className="hover-actions"><button className="btn btn-sm btn-phoenix-secondary me-1 fs-10"><span className="fas fa-check"></span></button>
<button className="btn btn-sm btn-phoenix-secondary fs-10"><span className="fas fa-trash"></span></button>
</div>
</div>
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/2.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">iPhone 13 pro max-Pacific Blue-128GB
                      storage</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/59.webp" alt="" /></div>
...
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">The order was delivered ahead of schedule. To
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/3.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple MacBook Pro 13 inch-M1-8/256GB-space</a>
</td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/58.webp" alt="" /></div>
...
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">It's a Mac, after all. Once you've gone Mac,
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/4.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple iMac 24" 4K Retina Display M1 8
                      Core CPU...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Eric McGee</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">Personally, I like the minimalist style, but I
                      wouldn't choose it if I were searching for a computer that I would use frequently. It's...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-start ps-5 status"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="clock" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end time white-space-nowrap">
<div className="hover-hide">
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/5.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Razer Kraken v3 x Wired 7.1 Surroung Sound
                      Gam...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
...
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">It performs exactly as expected. There are
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/6.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">PlayStation 5 DualSense Wireless
                      Controller</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/57.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Barbara Lucas</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">The controller is quite comfy for me. Despite
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/7.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB)
                      -...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/3.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Ansolo Lazinatov</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star-half-alt star-icon text-warning"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">The response time and service I received when
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/8.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Amazon Basics Matte Black Wired Keyboard - US
                      ...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/26.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Emma watson</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">I have started using this theme in the last
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/9.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Amazon Basics Mesh, Mid-Back, Swivel Office
                      De...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/29.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Rowen Atkinson</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">The best experience we could hope for. Customer
                      service team is amazing and the quality of their products is unsurpassed. Great theme ...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-start ps-5 status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Approved</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end time white-space-nowrap">
<div className="hover-hide">
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/10.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple Magic Mouse (Wireless, Rechargable) -
                      Si...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l">
...
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">This template has allowed me to convert my
                      existing web app into a great looking, easy to use UI in less than 2 weeks. Very easy to us...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-start ps-5 status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Approved</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end time white-space-nowrap">
<div className="hover-hide">
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/11.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Echo Dot (4th Gen) _ Smart speaker with Alexa
                      ...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/8.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Jennifer Schramm</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star-half-alt star-icon text-warning"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">The theme is really beautiful and the support
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/12.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">HORI Racing Wheel Apex for PlayStation 4_3,
                      an...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
...
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">As others mentioned, the team behind this theme
                      is super responsive. I sent a message during the weekend, fully expecting a response a...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-start ps-5 status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Approved</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end time white-space-nowrap">
<div className="hover-hide">
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/13.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Nintendo Switch with Neon Blue and Neon Red
                      Jo...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/9.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Michael Jenkins</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">I had a bit of a hard time at first but after I
                      contacted the team they were able to help me set up the theme. It's really good and I ...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-start ps-5 status"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="clock" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end time white-space-nowrap">
<div className="hover-hide">
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/14.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Oculus Rift S PC-Powered VR Gaming Headset</a>
</td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
...
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">Excellent. All my doubts were answered by the
...
<td className="align-middle product white-space-nowrap py-0"><a className="d-block rounded-2 border border-translucent" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/60x60/15.png" alt="" width="53" /></a></td>
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Sony X85J 75 Inch Sony 4K Ultra HD LED Smart
                      G...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle" src="/site/assets/img/team/40x40/24.webp" alt="" /></div>
<h6 className="mb-0 ms-3 text-body">Suzanne Martinez</h6>
</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star-half-alt star-icon text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fs-9 fw-semibold text-body-highlight mb-0">This theme is great. Clean and easy to
...
<button className="btn btn-link px-1 me-1" type="button" title="Previous" data-list-pagination="prev"><span className="fas fa-chevron-left me-2"></span>Previous</button>
<button className="btn btn-link px-1 ms-1" type="button" title="Next" data-list-pagination="next">Next<span className="fas fa-chevron-right ms-2"></span></button>
</div>
</div>
</div>
</div>
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/india.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/china.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/usa.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/south-korea.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/vietnam.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/russia.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/australia.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/england.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/indonesia.png" alt="" width="24" />
...
<div className="d-flex align-items-center"><img src="/site/assets/img/country/japan.png" alt="" width="24" />
...
<div className="py-2"><a className="dropdown-item" href="/apps/e-commerce/landing/product-details">
<div className="d-flex align-items-center">
<div className="fw-normal text-body-highlight title"><span className="fa-solid fa-file-zipper text-body" data-fa-transform="shrink-2"></span> Library
                            MacBook folder.rar</div>
</div>
</a>
<a className="dropdown-item" href="/apps/e-commerce/landing/product-details">
<div className="d-flex align-items-center">
<div className="fw-normal text-body-highlight title"> <span className="fa-solid fa-file-lines text-body" data-fa-transform="shrink-2"></span> Feature
...
<div className="dropdown-menu dropdown-menu-end py-2" aria-labelledby="support-chat-dropdown"><a className="dropdown-item" href="#!">Request a callback</a><a className="dropdown-item" href="#!">Search in
                  chat</a><a className="dropdown-item" href="#!">Show history</a><a className="dropdown-item" href="#!">Report
                  to Admin</a><a className="dropdown-item btn-support-chat" href="#!">Close Support</a></div>
</div>
</div>
...
<div className="avatar avatar-3xl status-online"><img className="rounded-circle border border-3 border-light-subtle" src="/site/assets/img/team/30.webp" alt="" />
</div>
<h5 className="mt-2 mb-3">Eric</h5>
<p className="text-center text-body-emphasis mb-0">Ask us anything – we’ll get back to you here or by email
                  within 24 hours.</p>
</div>
</div>
</div>
