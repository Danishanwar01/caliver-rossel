...
export default function AppsEmailEmailDetailPage() {
  return (
    <>
...
<p className="text-body-tertiary text-opacity-85 fs-9 fw-semibold mb-0 me-3"> <span className="text-body">1-7 </span>of <span className="text-body">205</span></p><button className="btn p-0 me-3" type="button"><span className="text-body-quaternary fa-solid fa-angle-left fs-10"></span></button>
...
<div className="d-flex flex-between-center pb-3 border-bottom border-translucent mb-4"><a className="btn btn-link p-0 text-body-secondary me-3" href="/apps/email/inbox"><span className="fa-solid fa-angle-left fw-bolder fs-8"></span></a>
<h3 className="flex-1 mb-0 lh-sm line-clamp-1">Query about recently purchased soccer socks</h3>
<div className="btn-reveal-trigger"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none d-flex btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h"></span></button>
...
<div className="col-12 col-sm-auto d-flex order-sm-1"><button className="btn p-0 me-4 me-lg-3 me-xl-4" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reply"><span className="fa-solid fa-reply text-body-quaternary"></span></button>
<button className="btn p-0 me-4 me-lg-3 me-xl-4" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Remove"><span className="fa-solid fa-trash-can text-body-quaternary"></span></button>
<button className="btn p-0 me-4 me-lg-3 me-xl-4" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive"><span className="fa-solid fa-archive text-body-quaternary"></span></button>
<button className="btn p-0 me-4 me-lg-3 me-xl-4" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Print"><span className="fa-solid fa-print text-body-quaternary"></span></button>
<button className="btn p-0" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Star"><span className="fa-regular fa-star text-body-quaternary"></span></button>
</div>
<div className="col-auto"><img className="me-2 rounded-circle" src="/site/assets/img/team/60.webp" alt="..." width="48" height="48" /></div>
<div className="col-auto flex-1">
<div className="d-flex mb-1">
<h5 className="mb-0 text-body-highlight me-2">Jessica Ball</h5>
<p className="mb-0 lh-sm text-body-tertiary fs-9 d-none d-md-block text-nowrap">&lt; jessica.ball@email.com &gt;</p>
</div>
<p className="mb-0 fs-9"><span className="text-body-tertiary">to</span><span className="fw-bold text-body-secondary"> Me </span><span className="text-body-highlight fw-semibold fs-10">28 Aug, 2021 </span><span className="fw-semibold text-body fs-10 me-1"> 6:32 PM</span><span className="fa-regular fa-star text-body-quaternary"></span></p>
</div>
</div>
...
<div className="d-flex align-items-center mb-5"><button className="btn btn-link text-body-highlight fs-8 text-decoration-none p-0" type="button"><span className="fa-solid fa-paperclip me-2"></span>2 Attachments</button></div>
<div className="row pb-11 border-bottom mb-4 gx-0 gy-2 border-translucent">
<div className="col-auto me-3"><a className="text-decoration-none d-flex align-items-center" href="#!">
<div className="btn-icon btn-icon-xl border rounded-3 text-body-quaternary text-opacity-75 flex-column me-2"><span className="fa-solid fa-file fs-8 mb-1"></span>
<p className="mb-0 fs-10 fw-bold">PDF</p>
</div>
<div>
<h6 className="text-body-highlight">workflow-data.pdf</h6>
<p className="fs-9 mb-0 text-body-tertiary lh-1">53.34 KB</p>
</div>
</a></div>
<div className="col-auto"><a className="text-decoration-none d-flex align-items-center" href="#!"><img className="rounded" src="/site/assets/img/generic/41.png" alt="..." />
<div className="ms-2">
<h6 className="text-body-highlight">forest.jpg</h6>
<p className="fs-9 mb-0 text-body-tertiary">53.34 KB</p>
</div>
</a></div>
</div>
<div className="d-flex justify-content-between"><button className="btn btn-phoenix-secondary me-1 text-nowrap px-2 px-sm-4">Reply<span className="fa-solid fa-reply ms-2 fs-10"></span></button>
<button className="btn btn-phoenix-secondary me-1 text-nowrap px-2 px-sm-4">Reply All<span className="fa-solid fa-reply-all ms-2 fs-10"></span></button>
<button className="btn btn-phoenix-secondary ms-auto text-nowrap px-2 px-sm-4">Forward<span className="fa-solid fa-share ms-2 fs-10"></span></button>
</div>
</div>
</div>
</div>
