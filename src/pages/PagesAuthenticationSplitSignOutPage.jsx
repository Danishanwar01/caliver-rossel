...
export default function PagesAuthenticationSplitSignOutPage() {
  return (
    <>
...
<div className="bg-holder" style={{backgroundImage: "url(../../../assets/img/bg/31.png)"}}></div>
...
<p className="text-body-tertiary">Thanks for using Phoenix. <br className="d-lg-none" />You are now successfully signed out.</p>
</div>
<div className="d-grid"><a className="btn btn-primary" href="/pages/authentication/split/sign-in"><span className="fas fa-angle-left me-2"></span>Go to sign in page</a></div>
</div>
</div>
</div>
</div>
