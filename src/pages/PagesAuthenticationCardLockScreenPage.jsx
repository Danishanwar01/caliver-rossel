...
export default function PagesAuthenticationCardLockScreenPage() {
  return (
    <>
...
<div className="avatar avatar-4xl mb-4"><img className="rounded-circle" src="/site/assets/img/team/30.webp" alt="" /></div>
<h2 className="text-body-highlight"> <span className="fw-normal">Hello </span>John Smith</h2>
<p className="text-body-tertiary">Enter your password to access <br className="d-sm-none d-md-block d-xxl-none" />the admin</p>
</div>
<div className="position-relative" data-password="data-password"><input className="form-control mb-3" id="password" type="password" placeholder="Enter Password" data-password-input="data-password-input" /><button className="btn px-3 py-0 h-100 position-absolute top-0 end-0 fs-7 text-body-tertiary" data-password-toggle="data-password-toggle"><span className="uil uil-eye show"></span><span className="uil uil-eye-slash hide"></span></button></div><a className="btn btn-primary w-100" href="/">Sign In</a>
</div>
</div>
</div>
</div>
