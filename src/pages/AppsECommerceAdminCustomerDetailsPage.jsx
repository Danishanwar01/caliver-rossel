...
export default function AppsECommerceAdminCustomerDetailsPage() {
  return (
    <>
...
<div className="avatar avatar-5xl"><img className="rounded-circle" src="/site/assets/img/team/15.webp" alt="" /></div>
</div>
...
<h3 className="me-1">Default Address</h3><button className="btn btn-link p-0"><span className="fas fa-pen fs-8 ms-3 text-body-quaternary"></span></button>
</div>
<h5 className="text-body-secondary">Address</h5>
<p className="text-body-secondary">Shatinon Mekalan<br />Vancouver, British Columbia<br />Canada</p>
<div className="mb-3">
<h5 className="text-body-secondary">Email</h5><a href="mailto:shatinon@jeemail.com">shatinon@jeemail.com</a>
</div>
<h5 className="text-body-secondary">Phone</h5><a className="text-body-secondary" href="tel:+1234567890">+1234567890</a>
</div>
</div>
</div>
...
<p className="text-body-highlight mb-1">Gave us a nice feedback</p>
<div className="text-end">
<p className="text-body-tertiary text-opacity-85 mb-0">12 Nov, 2020</p>
</div>
</div>
<div className="fs-9 fw-semibold pb-4 mb-4 border-bottom border-dashed">
<p className="text-body-highlight mb-1">Customer added product to cart and then forgot to checkout. Later knocked the customer support to ask about update on shipping. Later, settled on “One day Shipping” though “Free delivery” was preferred. Overall good behavior.</p>
<div className="text-end">
<p className="text-body-tertiary text-opacity-85 mb-0">23 Dec, 2019</p>
</div>
</div>
<div className="fs-9 fw-semibold pb-4 mb-4 border-bottom border-dashed">
<p className="text-body-highlight mb-1">User of this support ticket won a 100% off coupon and received top-notch service from the technical support engineer. Along with providing a good review, user highly appreciated the team.</p>
<div className="text-end">
<p className="text-body-tertiary text-opacity-85 mb-0">2 Oct, 2019</p>
</div>
</div>
<div className="fs-9 fw-semibold">
<p className="text-body-highlight mb-1">Customer returned and bought 2 related items, which is currently being shipped. Customer chose “One day Shipping”. Additional notes were added regarding customised wrapping. Customer submitted positive review.</p>
<div className="text-end">
<p className="text-body-tertiary text-opacity-85 mb-0">26 Apr, 2019</p>
</div>
</div>
</div>
</div>
...
<div className="mb-6">
<h3 className="mb-4">Orders <span className="text-body-tertiary fw-normal">(97)</span></h3>
<div className="border-top border-bottom border-translucent" id="customerOrdersTable" data-list="&#123;&quot;valueNames&quot;:[&quot;order&quot;,&quot;total&quot;,&quot;payment_status&quot;,&quot;fulfilment_status&quot;,&quot;delivery_type&quot;,&quot;date&quot;],&quot;page&quot;:6,&quot;pagination&quot;:true&#125;">
<div className="table-responsive scrollbar">
<table className="table table-sm fs-9 mb-0">
<thead>
<tr>
<th className="sort white-space-nowrap align-middle ps-0 pe-3" scope="col" data-sort="order" style={{width: "10%"}}>ORDER</th>
<th className="sort align-middle text-end pe-7" scope="col" data-sort="total" style={{width: "10%"}}>TOTAL</th>
<th className="sort align-middle white-space-nowrap pe-3" scope="col" data-sort="payment_status" style={{width: "15%"}}>PAYMENT STATUS</th>
<th className="sort align-middle white-space-nowrap text-start pe-3" scope="col" data-sort="fulfilment_status" style={{width: "20%"}}>FULFILMENT STATUS</th>
<th className="sort align-middle white-space-nowrap text-start" scope="col" data-sort="delivery_type" style={{width: "30%"}}>DELIVERY TYPE</th>
<th className="sort align-middle text-end pe-0" scope="col" data-sort="date">DATE</th>
<th className="sort text-end align-middle pe-0 ps-5" scope="col"></th>
</tr>
</thead>
<tbody className="list" id="customer-order-table-body">
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2453</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$87</td>
...
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Order Fulfilled</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2452</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$7264</td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2451</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$375</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Partial FulfiLled</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2450</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$657</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-secondary"><span className="badge-label">Cancelled</span><span className="ms-1" data-feather="x" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-secondary"><span className="badge-label">Order CancelLed</span><span className="ms-1" data-feather="x" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2449</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$9562</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-danger"><span className="badge-label">Failed</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Order Fulfilled</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2448</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$46</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Paid</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-danger"><span className="badge-label">Delivery Delayed</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2447</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$953</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2446</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$12</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Fulfiled</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">Standard shipping</td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2445</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$3927</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Paid</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2444</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$5937</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Paid</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2443</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$124</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-danger"><span className="badge-label">Failed</span><span className="ms-1" data-feather="minus-circle" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2442</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$542</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Fulfiled</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">Standard shipping</td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2441</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$1480</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Paid</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-info"><span className="badge-label">Ready to pickup</span><span className="ms-1" data-feather="info" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">Local delivery</td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2440</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$80</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-secondary"><span className="badge-label">Cancelled</span><span className="ms-1" data-feather="x" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-danger"><span className="badge-label">Unfulfiled</span><span className="ms-1" data-feather="x" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">Free shipping</td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="order align-middle white-space-nowrap ps-0"><a className="fw-semibold" href="#!">#2439</a></td>
<td className="total align-middle text-end fw-semibold pe-7 text-body-highlight">$999</td>
<td className="payment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="fulfilment_status align-middle white-space-nowrap text-start fw-bold text-body-tertiary"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Fulfiled</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">Cash on delivery</td>
...
<div className="mb-6">
<h3 className="mb-4">Wishlist <span className="text-body-tertiary fw-normal">(43)</span></h3>
<div className="border-translucent border-top border-bottom" id="customerWishlistTable" data-list="&#123;&quot;valueNames&quot;:[&quot;products&quot;,&quot;color&quot;,&quot;size&quot;,&quot;price&quot;,&quot;quantity&quot;,&quot;total&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true&#125;">
<div className="table-responsive scrollbar">
<table className="table fs-9 mb-0">
<thead>
<tr>
<th className="sort white-space-nowrap align-middle fs-10" scope="col" style={{width: "5%"}}></th>
<th className="sort white-space-nowrap align-middle" scope="col" style={{width: "35%", minWidth: "250px"}} data-sort="products">PRODUCTS</th>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/1.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">Fitbit Sense Advanced Smartwatch wi...</a></td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$57</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/7.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, ...</a></td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$1499</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/6.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">PlayStation 5 DualSense Wireless Cont...</a></td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$359</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/3.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">Apple MacBook Pro 13 inch-M1-8/256G...</a></td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$1,799</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/4.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">Apple iMac 24" 4K Retina Display M1 8 C...</a></td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$65</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/10.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">Apple Magic Mouse (Wireless, Recharg...</a></td>
<td className="color align-middle white-space-nowrap fs-9 text-body">White</td>
<td className="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">Regular</td>
<td className="price align-middle text-body fs-9 fw-semibold text-end">$30</td>
<td className="total align-middle fw-bold text-body-highlight text-end">$60</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/8.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">Amazon Basics Matte Black Wired Keybo...</a></td>
<td className="color align-middle white-space-nowrap fs-9 text-body">Black</td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$40</td>
</tr>
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/12.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">HORI Racing Wheel Apex for PlayStation...</a></td>
<td className="color align-middle white-space-nowrap fs-9 text-body">Black</td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle white-space-nowrap py-1"><a className="border border-translucent rounded-2 d-inline-block" href="/apps/e-commerce/landing/product-details"><img src="/site/assets/img/products/17.png" alt="" width="40" height="40" /></a></td>
<td className="products align-middle"><a className="fw-semibold mb-0" href="/apps/e-commerce/landing/product-details">Xbox Series S</a></td>
<td className="color align-middle white-space-nowrap fs-9 text-body">Space Gray</td>
...
<td className="total align-middle fw-bold text-body-highlight text-end">$99</td>
</tr>
</tbody>
</table>
</div>
...
<div>
<h3 className="mb-4">Ratings & reviews <span className="text-body-tertiary fw-normal">(43)</span></h3>
<div className="border-top border-bottom border-translucent" id="customerRatingsTable" data-list="&#123;&quot;valueNames&quot;:[&quot;product&quot;,&quot;rating&quot;,&quot;review&quot;,&quot;status&quot;,&quot;date&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true&#125;">
<div className="table-responsive scrollbar">
<table className="table fs-9 mb-0">
<thead>
<tr>
<th className="sort white-space-nowrap align-middle ps-0" scope="col" style={{width: "20%"}} data-sort="product">PRODUCT</th>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple Magic Mouse (Wireless, Rech...</a></td>
...
<p className="fw-semibold text-body-highlight mb-0">It's lovely, works right out of the box (as you'd expect from an Apple device), and has a number of useful functions.</p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Success</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Fitbit Sense Advanced Smartwatch ...</a></td>
...
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">This is an exceptional smartwatch, featuring a wealth of useful functions at an affordable price. The watch is small ...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Success</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
<p className="text-body-tertiary mb-0">Dec 9, 2:28PM</p>
</td>
<td className="align-middle white-space-nowrap text-end pe-0">
<div className="btn-reveal-trigger position-static"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">HORI Racing Wheel Apex for PlaySt...</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">This steering wheel is a great buy! It works well and feels good, however I wish it had a wider diameter like a real ...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Razer Kraken v3 x Wired 7.1 Surro...</a></td>
...
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">My son says these are the greatest he's ever tasted.</p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-secondary"><span className="badge-label">Cancelled</span><span className="ms-1" data-feather="x" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">iPhone 13 pro max-Pacific Blue-12...</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">I chose wisely. The phone is in excellent condition, with no scratches or dents, excellent battery life, and flawless...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Success</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple MacBook Pro 13 inch-M1-8/25...</a></td>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple iMac 24" 4K Retina Display ...</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">The best experience we could hope for. Customer service team is amazing and the quality of their products is unsurpas...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
<p className="text-body-tertiary mb-0">Nov 09, 3:23 AM</p>
</td>
<td className="align-middle white-space-nowrap text-end pe-0">
<div className="btn-reveal-trigger position-static"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">PlayStation 5 DualSense Wireless ...</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">My son says these are the greatest he's ever tasted.</p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-success"><span className="badge-label">Success</span><span className="ms-1" data-feather="check" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
<p className="text-body-tertiary mb-0">Nov 08, 8:53 AM</p>
</td>
<td className="align-middle white-space-nowrap text-end pe-0">
<div className="btn-reveal-trigger position-static"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">2021 Apple 12.9-inch iPad Pro (Wi...</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star-half-alt star-icon text-warning"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">The response time and service I received when contacted the designers were Phenomenal!</p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
...
<tr className="hover-actions-trigger btn-reveal-trigger position-static">
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Amazon Basics Matte Black Wired K...</a></td>
<td className="align-middle rating white-space-nowrap fs-10"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
<td className="align-middle review" style={{minWidth: "350px"}}>
<p className="fw-semibold text-body-highlight mb-0">I chose wisely. The phone is in excellent condition, with no scratches or dents, excellent battery life, and flawless...<a href="#!">See more</a></p>
</td>
<td className="align-middle text-end status"><span className="badge badge-phoenix fs-10 badge-phoenix-warning"><span className="badge-label">Pending</span><span className="ms-1" data-feather="alert-octagon" style={{height: "12.8px", width: "12.8px"}}></span></span></td>
<td className="align-middle text-end date white-space-nowrap">
<p className="text-body-tertiary mb-0">Nov 07, 11:20 AM</p>
</td>
<td className="align-middle white-space-nowrap text-end pe-0">
<div className="btn-reveal-trigger position-static"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
