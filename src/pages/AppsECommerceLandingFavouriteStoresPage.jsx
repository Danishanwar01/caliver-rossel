...
export default function AppsECommerceLandingFavouriteStoresPage() {
  return (
    <>
...
<h2 className="mb-1">My Favourite Stores</h2>
<p className="mb-5 text-body-tertiary fw-semibold">Essential for a better life</p>
<div className="row gx-3 gy-5">
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/dell.png" alt="Dell Technologies" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/intel-2.png" alt="Intel" /></div>
<h5 className="mb-2">Intel</h5>
...
<p className="text-body-quaternary fs-9 mb-2 fw-semibold">(1542 people rated)</p><a className="btn btn-link p-0" href="#!">Visit Store<span className="fas fa-chevron-right ms-1 fs-10"></span></a>
<div className="hover-actions top-0 end-0 mt-2 me-3">
<div className="btn-reveal-trigger"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal lh-1 bg-body-highlight rounded-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-9"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
<div className="dropdown-divider"></div><a className="dropdown-item text-danger" href="#!">Remove</a>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/honda.png" alt="Honda" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/asus-rog.png" alt="Asus ROG" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/yamaha.png" alt="Yamaha" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/ibm.png" alt="IBM" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/apple-2.png" alt="Apple Store" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/oppo.png" alt="Oppo" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/redragon.png" alt="Redragon" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/xbox.png" alt="Microsoft XBOX" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/lenovo.png" alt="Lenovo" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/xiaomi.png" alt="Xiaomi" /></div>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/oneplus-2.png" alt="Oneplus" /></div>
<h5 className="mb-2">Oneplus</h5>
<div className="mb-1 fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></div>
<p className="text-body-quaternary fs-9 mb-2 fw-semibold">(562 people rated)</p><a className="btn btn-link p-0" href="#!">Visit Store<span className="fas fa-chevron-right ms-1 fs-10"></span></a>
<div className="hover-actions top-0 end-0 mt-2 me-3">
<div className="btn-reveal-trigger"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal lh-1 bg-body-highlight rounded-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-9"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
<div className="dropdown-divider"></div><a className="dropdown-item text-danger" href="#!">Remove</a>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/suzuki-2.png" alt="Suzuki" /></div>
<h5 className="mb-2">Suzuki</h5>
<div className="mb-1 fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></div>
<p className="text-body-quaternary fs-9 mb-2 fw-semibold">(125 people rated)</p><a className="btn btn-link p-0" href="#!">Visit Store<span className="fas fa-chevron-right ms-1 fs-10"></span></a>
<div className="hover-actions top-0 end-0 mt-2 me-3">
<div className="btn-reveal-trigger"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal lh-1 bg-body-highlight rounded-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-9"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
<div className="dropdown-divider"></div><a className="dropdown-item text-danger" href="#!">Remove</a>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/google-store.png" alt="Google store" /></div>
<h5 className="mb-2">Google store</h5>
<div className="mb-1 fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></div>
<p className="text-body-quaternary fs-9 mb-2 fw-semibold">(1859 people rated)</p><a className="btn btn-link p-0" href="#!">Visit Store<span className="fas fa-chevron-right ms-1 fs-10"></span></a>
<div className="hover-actions top-0 end-0 mt-2 me-3">
<div className="btn-reveal-trigger"><button className="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal lh-1 bg-body-highlight rounded-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-9"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">View</a><a className="dropdown-item" href="#!">Export</a>
<div className="dropdown-divider"></div><a className="dropdown-item text-danger" href="#!">Remove</a>
...
<div className="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
<div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{height: "180px"}}><img className="mw-100" src="/site/assets/img/brands/hp.png" alt="HP Global Store" /></div>
