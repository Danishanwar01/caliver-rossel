...
export default function PagesAuthenticationSimple2faPage() {
  return (
    <>
...
<div className="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a className="d-flex flex-center text-decoration-none mb-4" href="/">
