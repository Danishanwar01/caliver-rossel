...
export default function PagesAuthenticationCardSignOutPage() {
  return (
    <>
...
<div className="text-center mb-6 mx-auto"><img className="mb-7 d-dark-none" src="/site/assets/img/spot-illustrations/1.png" alt="phoenix" /><img className="mb-7 d-light-none" src="/site/assets/img/spot-illustrations/dark_1.png" alt="phoenix" />
<div className="mb-6">
<h4 className="text-body-highlight">Come back soon!</h4>
<p className="text-body-tertiary">Thanks for using Phoenix. <br className="d-lg-none" />You are now successfully <br className="d-sm-none" />signed out.</p>
</div>
<div className="d-grid"><a className="btn btn-primary" href="/pages/authentication/card/sign-in"><span className="fas fa-angle-left me-2"></span>Go to sign in page</a></div>
</div>
</div>
</div>
</div>
