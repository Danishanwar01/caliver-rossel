...
export default function PagesAuthenticationSimpleForgotPasswordPage() {
  return (
    <>
...
<p className="text-body-tertiary mb-5">Enter your email below and we will send <br className="d-sm-none" />you a reset link</p>
