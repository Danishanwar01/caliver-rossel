...
export default function PagesNotificationsPage() {
  return (
    <>
...
<div className="avatar avatar-xl me-3"><img className="rounded-circle" src="/site/assets/img/team/30.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Jessie Samson</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">💬</span>Mentioned you in a comment<span className="fw-bold"> "Well done! Proud of you ❤️ " </span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10">10m</span></p>
...
<div className="dropdown"><button className="btn fs-10 btn-sm dropdown-toggle dropdown-caret-none transition-none notification-dropdown-toggle" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10 text-body"></span></button>
...
<p className="fs-9 text-body-highlight"><span className="me-1">📅</span>Created an event<span className="fw-bold"> Rome holidays</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10">20m</span></p>
...
<div className="d-flex align-items-center justify-content-between py-3 px-lg-6 px-4 notification-card border-top unread">
<div className="d-flex">
<div className="avatar avatar-xl me-3"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/avatar.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Jessie Samson</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">👍</span>Liked your comment<span className="fw-bold"> "Amazing Works️"</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10">1h</span></p>
...
<h5 className="text-semibold text-body-emphasis mb-3">Yesterday</h5>
<div className="mx-n4 mx-lg-n6 mb-9 border-bottom">
<div className="d-flex align-items-center justify-content-between py-3 px-lg-6 px-4 notification-card border-top unread">
<div className="d-flex">
<div className="avatar avatar-xl me-3"><img className="rounded-circle" src="/site/assets/img/team/57.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Kiera Anderson</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">💬</span>Mentioned you in a comment<span className="fw-bold"> "This is too good to be true!"</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10"></span></p>
...
<div className="d-flex align-items-center justify-content-between py-3 px-lg-6 px-4 notification-card border-top unread">
<div className="d-flex">
<div className="avatar avatar-xl me-3"><img className="rounded-circle" src="/site/assets/img/team/59.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Herman Carter</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">👤</span>Tagged you in a<span className="fw-bold"> post</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10"></span></p>
...
<div className="d-flex align-items-center justify-content-between py-3 px-lg-6 px-4 notification-card border-top read">
<div className="d-flex">
<div className="avatar avatar-xl me-3"><img className="rounded-circle" src="/site/assets/img/team/58.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Benjamin Button</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">👍</span>Liked your comment<span className="fw-bold"> "Welcome to the team️"</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10"></span></p>
...
<div className="d-flex align-items-center justify-content-between py-3 px-lg-6 px-4 notification-card border-top read">
<div className="d-flex">
<div className="avatar avatar-xl me-3"><img className="rounded-circle" src="/site/assets/img/team/60.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Aron Paul</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">📷</span>Tagged you in a<span className="fw-bold"> photo</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10"></span></p>
<p className="text-body-secondary fs-9 mb-0"><span className="me-1 fas fa-clock"></span><span className="fw-bold">9:53 AM </span>August 7,2021</p>
</div>
</div>
<div className="dropdown"><button className="btn fs-10 btn-sm dropdown-toggle dropdown-caret-none transition-none notification-dropdown-toggle" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10 text-body"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">Mark as unread</a></div>
...
<div className="d-flex align-items-center justify-content-between py-3 px-lg-6 px-4 notification-card border-top read">
<div className="d-flex">
<div className="avatar avatar-xl me-3"><img className="rounded-circle" src="/site/assets/img/team/34.webp" alt="" /></div>
<div className="me-3 flex-1 mt-2">
<h4 className="fs-9 text-body-emphasis">Rick Sanchez</h4>
<p className="fs-9 text-body-highlight"><span className="me-1">💬</span>Mentioned you in a comment<span className="fw-bold"> "You need to see these amazing photos️"</span><span className="ms-2 text-body-tertiary text-opacity-85 fw-bold fs-10"></span></p>
<p className="text-body-secondary fs-9 mb-0"><span className="me-1 fas fa-clock"></span><span className="fw-bold">9:45 AM </span>August 7,2021</p>
</div>
</div>
<div className="dropdown"><button className="btn fs-10 btn-sm dropdown-toggle dropdown-caret-none transition-none notification-dropdown-toggle" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span className="fas fa-ellipsis-h fs-10 text-body"></span></button>
<div className="dropdown-menu dropdown-menu-end py-2"><a className="dropdown-item" href="#!">Mark as unread</a></div>
