...
export default function AppsECommerceLandingShippingInfoPage() {
  return (
    <>
...
<div className="col-12"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputName">Full name</label><input className="form-control" id="inputName" type="text" placeholder="Full name" /></div>
<div className="col-md-6"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputEmail">Email</label><input className="form-control" id="inputEmail" type="email" placeholder="Email" /></div>
<div className="col-md-6"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputPhone">Phone</label><input className="form-control" id="inputPhone" type="tel" placeholder="+1234567890" /></div>
<div className="col-12"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputAddress1">Address line 1</label><input className="form-control" id="inputAddress1" type="text" placeholder="Address line 1" /></div>
<div className="col-12"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputAddress2">Address line 2</label><input className="form-control" id="inputAddress2" type="text" placeholder="Address line 2" /></div>
<div className="col-md-4"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputCity">City</label><select className="form-select text-body-emphasis" id="inputCity">
<option selected>Van Nuys</option>
<option value="los-angeles">Los Angeles</option>
<option value="chicago">Chicago</option>
<option value="houston">Houston</option>
</select></div>
<div className="col-md-4"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputState">State</label><select className="form-select text-body-emphasis" id="inputState">
<option selected>California</option>
<option value="Alaska">Alaska</option>
<option value="alabama">Alabama</option>
<option value="florida">Florida</option>
</select></div>
<div className="col-md-4"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputZipCode">Zip code</label><input className="form-control number-arrows-none" id="inputZipCode" type="number" placeholder="Zip code" /></div>
<div className="col-md-4 mb-3"><label className="form-label fs-8 text-body-highlight ps-0 text-transform-none" htmlFor="inputCountry">Country</label><select className="form-select text-body-emphasis" id="inputCountry">
<option selected>USA</option>
<option value="uk">UK</option>
<option value="aus">AUS</option>
<option value="nz">NZ</option>
</select></div>
<div className="col-12"><button className="btn btn-primary px-8 px-sm-11 me-2" type="submit">Save</button>
<button className="btn btn-phoenix-secondary text-nowrap" type="submit">Exit Without Saving</button>
</div>
</div>
</form>
</div>
