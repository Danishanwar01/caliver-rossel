...
export default function PagesAuthenticationSplitSignInPage() {
  return (
    <>
...
<div className="bg-holder" style={{backgroundImage: "url(../../../assets/img/bg/30.png)"}}></div>
...
<div className="col-auto"><a className="fs-9 fw-semibold" href="/pages/authentication/simple/forgot-password">Forgot Password?</a></div>
</div><button className="btn btn-primary w-100 mb-3">Sign In</button>
<div className="text-center"><a className="fs-9 fw-bold" href="/pages/authentication/split/sign-up">Create an account</a></div>
</div>
</div>
</div>
</div>
