...
<div className="col-auto"><button className="btn btn-sm btn-phoenix-secondary bg-body-emphasis bg-body-hover me-2" type="button">All products</button>
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Fitbit Sense Advanced Smartwatch with Tools fo...</a></td>
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple iMac 24" 4K Retina Display M1 8 Core CPU...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Razer Kraken v3 x Wired 7.1 Surroung Sound Gam...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">PlayStation 5 DualSense Wireless Controller</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) -...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Amazon Basics Matte Black Wired Keyboard - US ...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Amazon Basics Mesh, Mid-Back, Swivel Office De...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Apple Magic Mouse (Wireless, Rechargable) - Si...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Echo Dot (4th Gen) _ Smart speaker with Alexa ...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">HORI Racing Wheel Apex for PlayStation 4_3, an...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Nintendo Switch with Neon Blue and Neon Red Jo...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Oculus Rift S PC-Powered VR Gaming Headset</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
<div className="avatar avatar-l"><img className="rounded-circle avatar-placeholder" src="/site/assets/img/team/40x40/avatar.webp" alt="" /></div>
...
<td className="align-middle product white-space-nowrap"><a className="fw-semibold" href="/apps/e-commerce/landing/product-details">Sony X85J 75 Inch Sony 4K Ultra HD LED Smart G...</a></td>
<td className="align-middle customer white-space-nowrap"><a className="d-flex align-items-center text-body" href="/apps/e-commerce/landing/profile">
