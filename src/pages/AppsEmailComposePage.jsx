...
export default function AppsEmailComposePage() {
  return (
    <>
...
<div className="scrollbar email-content">
...
<div className="col-4"><input className="form-control" type="email" placeholder="To" /></div>
<div className="col-4"><input className="form-control" type="email" placeholder="CC" /></div>
<div className="col-4"><input className="form-control" type="email" placeholder="BCC" /></div>
<div className="col-12"><input className="form-control" type="text" placeholder="Subject" /></div>
</div>
<div className="mb-3 flex-1"><textarea className="tinymce email-textarea" name="content" data-tinymce="&#123;&quot;height&quot;:&quot;100%&quot;&#125;"></textarea></div>
<div className="d-flex justify-content-between align-items-center">
<div className="d-flex"><label className="btn btn-link py-0 px-2 text-body fs-9" htmlFor="emailAttachment"> <span className="fa-solid fa-paperclip"></span></label><input className="d-none" id="emailAttachment" type="file" /><label className="btn btn-link py-0 px-2 text-body fs-9" htmlFor="emailPhotos"><span className="fa-solid fa-image"></span></label><input className="d-none" id="emailPhotos" type="file" accept="image/*" /></div>
<div className="d-flex"><button className="btn btn-link text-body fs-10 text-decoration-none">Discard</button>
<button className="btn btn-primary fs-10" type="submit">Send<span className="fa-solid fa-paper-plane ms-1"></span></button>
</div>
</div>
</form>
</div>
