...
export default function PagesAuthenticationSimpleSignInPage() {
  return (
    <>
...
<div className="text-center"><a className="fs-9 fw-bold" href="/pages/authentication/simple/sign-up">Create an account</a></div>
</div>
</div>
</div>
