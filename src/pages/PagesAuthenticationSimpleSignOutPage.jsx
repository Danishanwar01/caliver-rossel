...
export default function PagesAuthenticationSimpleSignOutPage() {
  return (
    <>
...
<div className="d-grid"><a className="btn btn-primary" href="/pages/authentication/simple/sign-in"><span className="fas fa-angle-left me-2"></span>Go to sign in page</a></div>
</div>
</div>
</div>
</div>
