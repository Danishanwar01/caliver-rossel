...
export default function PagesAuthenticationSplitSignUpPage() {
  return (
    <>
...
<div className="bg-holder" style={{backgroundImage: "url(../../../assets/img/bg/32.png)"}}></div>

</div>
<div className="col-lg-6">
<div className="row flex-center h-100 g-0 px-4 px-sm-0">
<div className="col col-sm-6 col-lg-7 col-xl-6"><a className="d-flex flex-center text-decoration-none mb-4" href="/">
...
<div className="text-center"><a className="fs-9 fw-bold" href="/pages/authentication/split/sign-in">Sign in to an existing account</a></div>
</form>
</div>
</div>
</div>
