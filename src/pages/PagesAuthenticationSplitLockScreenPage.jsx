...
export default function PagesAuthenticationSplitLockScreenPage() {
  return (
    <>
...
<div className="bg-holder" style={{backgroundImage: "url(../../../assets/img/bg/33.png)"}}></div>
...
<p className="text-body-tertiary">Enter your password to access the admin</p>
</div>
