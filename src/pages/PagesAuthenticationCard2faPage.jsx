...
export default function PagesAuthenticationCard2faPage() {
  return (
    <>
...
<div className="text-center"><a className="d-flex flex-center text-decoration-none mb-4" href="/">
...
<p className="text-body-tertiary mb-0">An email containing a 6-digit verification code has been sent to the email address - exa*********.com </p>
<p className="fs-10 mb-5">Don’t have access? <a href="#!">Use another method</a></p>
<form className="verification-form" data-2fa-form="data-2fa-form">
<div className="d-flex align-items-center gap-2 mb-3"><input className="form-control px-2 text-center" type="number" /><input className="form-control px-2 text-center" type="number" /><input className="form-control px-2 text-center" type="number" /><span>-</span><input className="form-control px-2 text-center" type="number" /><input className="form-control px-2 text-center" type="number" /><input className="form-control px-2 text-center" type="number" /></div>
<div className="form-check text-start mb-4"><input className="form-check-input" id="2fa-checkbox" type="checkbox" /><label htmlFor="2fa-checkbox">Don’t ask again on this device</label></div><button className="btn btn-primary w-100 mb-5" type="submit" disabled>Verify</button><a className="fs-9" href="#!">Didn’t receive the code? </a>
</form>
</div>
</div>
</div>
