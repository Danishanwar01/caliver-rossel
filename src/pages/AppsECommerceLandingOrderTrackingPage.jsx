...
export default function AppsECommerceLandingOrderTrackingPage() {
  return (
    <>
...
</div><button className="btn btn-outline-primary mt-3"><span className="fa-solid fa-phone me-2"></span>Call Support</button>
</div>
...
<div className="icon-item icon-item-sm bg-success" data-bs-theme="light"><span className="fa-solid fa-check text-white fs-10"></span></div><span className="timeline-bar border-end border-success"></span>
</div>
</div>
<div className="col">
...
<div className="timeline-item-bar position-relative me-3 me-md-0">
<div className="icon-item icon-item-sm bg-success" data-bs-theme="light"><span className="fa-solid fa-check text-white fs-10"></span></div><span className="timeline-bar border-end border-warning"></span>
</div>
</div>
<div className="col">
<div className="timeline-item-content ps-6 ps-md-3">
...
<div className="timeline-item-bar position-relative me-3 me-md-0">
<div className="icon-item icon-item-sm bg-warning" data-bs-theme="light"><span className="fa-solid fa-truck-ramp-box text-white fs-10"></span></div><span className="timeline-bar border-end border-dashed"></span>
</div>
</div>
<div className="col">
<div className="timeline-item-content ps-6 ps-md-3">
...
<div className="timeline-item-bar position-relative me-3 me-md-0">
<div className="icon-item icon-item-sm bg-body-quaternary" data-bs-theme="light"><span className="fa-solid fa-truck text-white fs-10"></span></div><span className="timeline-bar border-end border-dashed"></span>
</div>
</div>
<div className="col">
<div className="timeline-item-content ps-6 ps-md-3">
...
<div className="timeline-item-bar position-relative me-3 me-md-0">
<div className="icon-item icon-item-sm bg-body-quaternary" data-bs-theme="light"><span className="fa-solid fa-truck-fast text-white fs-10"></span></div>
</div>
</div>
<div className="col">
<div className="timeline-item-content ps-6 ps-md-3">
