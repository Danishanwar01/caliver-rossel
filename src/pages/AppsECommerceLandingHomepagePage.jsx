...
export default function AppsECommerceLandingHomepagePage() {
  return (
    <>
...
<div className="d-flex justify-content-between"><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2 bg-warning-subtle" data-bs-theme="light"><span className="fs-4 uil uil-star text-warning"></span></div>
<p className="nav-label">Deals</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-shopping-bag"></span></div>
<p className="nav-label">Grocery</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-watch-alt"></span></div>
<p className="nav-label">Fashion</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-mobile-android"></span></div>
<p className="nav-label">Mobile</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-monitor"></span></div>
<p className="nav-label">Electronics</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-estate"></span></div>
<p className="nav-label">Home</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-lamp"></span></div>
<p className="nav-label">Dining</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-gift"></span></div>
<p className="nav-label">Gifts</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-wrench"></span></div>
<p className="nav-label">Tools</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-plane-departure"></span></div>
<p className="nav-label">Travel</p>
</a><a className="icon-nav-item" href="#!">
<div className="icon-container mb-2" data-bs-theme="undefined"><span className="fs-4 uil uil-palette"></span></div>
...
<h2 className="text-warning-light fw-bolder fs-lg-3 fs-xxl-2">Whooping <span className="gradient-text">60% </span>Off</h2>
<h3 className="fw-bolder fs-lg-5 fs-xxl-3 text-white">on everyday items</h3>
</div><a className="btn btn-lg btn-primary rounded-pill banner-button" href="#!">Shop Now</a>
</div>
</div>
...
<h2 className="text-white fw-bolder fs-xl-4">Get <span className="gradient-text">10% Off </span><br className="d-md-none" /> on gift items</h2><a className="btn btn-lg btn-primary rounded-pill banner-button" href="#!">Buy Now</a>
</div>
</div>
</div>
<div className="col-12 col-xl-6">
...
<h2 className="text-white fw-bolder fs-sm-4 mb-5">MI 11 Pro<br /><span className="fs-7 fs-sm-6"> Best in the market</span></h2><a className="btn btn-lg btn-warning rounded-pill banner-button" href="#!">Buy Now</a>
</div>
</div>
<div className="col-4"><img className="w-100 w-sm-75" src="/site/assets/img/e-commerce/5.png" alt="" /></div>
</div>
</div>
</div>
</div>
...
<div className="d-flex"><span className="fas fa-bolt text-warning fs-6"></span>
<h3 className="mx-2">Top Deals today</h3><span className="fas fa-bolt text-warning fs-6"></span>
</div><a className="btn btn-link btn-lg p-0 d-none d-md-block" href="#!">Explore more<span className="fas fa-chevron-right fs-9 ms-1"></span></a>
</div>
...
<div>
<p className="fs-9 text-body-highlight fw-bold mb-2">dbrand skin available</p>
...
<div className="d-flex align-items-center mb-1">
<p className="me-2 text-body text-decoration-line-through mb-0">$1299.00</p>
...
</div><a className="fw-bold d-md-none px-0" href="#!">Explore more<span className="fas fa-chevron-right fs-9 ms-1"></span></a>
</div>
...
<div className="col-12 d-lg-none"><a href="#!"><img className="w-100 rounded-3" src="/site/assets/img/e-commerce/6.png" alt="" /></a></div>
</div>
<div className="mb-6">
<div className="d-flex flex-between-center mb-3">
<h3>Top Electronics</h3><a className="fw-bold d-none d-md-block" href="#!">Explore more<span className="fas fa-chevron-right fs-9 ms-1"></span></a>
</div>
<div className="swiper-theme-container products-slider">
...
<div>
<p className="fs-9 text-body-highlight fs-9 mb-0 fw-bold">Leather cover add-on available</p>
<p className="fs-9 text-body-tertiary fs-9 mb-2">supports Windows 11</p>
...
<div>
<p className="fs-9 text-body-highlight fs-9 mb-0 fw-bold">Free with iPhone 5s</p>
<p className="fs-9 text-body-tertiary fs-9 mb-2">Ships to Canada</p>
<h3 className="text-body-emphasis">$59.00</h3>
...
<p className="fs-9"><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="text-body-quaternary fw-semibold ms-1">(6 people rated)</span></p>
</div>
<div>
<p className="fs-9 text-body-highlight fs-9 mb-0 fw-bold">Bundle available</p>
<p className="fs-9 text-body-tertiary fs-9 mb-2">Charger not included</p>
...
<div className="d-flex flex-column justify-content-between h-100">
<div>
<div className="border border-1 border-translucent rounded-3 position-relative mb-3"><button className="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img className="img-fluid" src="/site/assets/img/products/8.png" alt="" /></div><a className="stretched-link" href="/apps/e-commerce/landing/product-details">
<h6 className="mb-2 lh-sm line-clamp-3 product-name">Amazon Basics Matte Black Wired Keyboard - US Layout (QWERTY)</h6>
</a>
<p className="fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span className="text-body-quaternary fw-semibold ms-1">(7 people rated)</span></p>
</div>
<div>
...
</div><a className="fw-bold d-md-none" href="#!">Explore more<span className="fas fa-chevron-right fs-9 ms-1"></span></a>
</div>
<div className="mb-6">
<div className="d-flex flex-between-center mb-3">
<h3>Best Offers</h3><a className="fw-bold d-none d-md-block" href="#!">Explore more<span className="fas fa-chevron-right fs-9 ms-1"></span></a>
</div>
<div className="swiper-theme-container products-slider">
<div className="swiper swiper theme-slider" data-swiper="&#123;&quot;slidesPerView&quot;:1,&quot;spaceBetween&quot;:16,&quot;breakpoints&quot;:&#123;&quot;450&quot;:&#123;&quot;slidesPerView&quot;:2,&quot;spaceBetween&quot;:16&#125;,&quot;576&quot;:&#123;&quot;slidesPerView&quot;:3,&quot;spaceBetween&quot;:20&#125;,&quot;768&quot;:&#123;&quot;slidesPerView&quot;:4,&quot;spaceBetween&quot;:20&#125;,&quot;992&quot;:&#123;&quot;slidesPerView&quot;:5,&quot;spaceBetween&quot;:20&#125;,&quot;1200&quot;:&#123;&quot;slidesPerView&quot;:6,&quot;spaceBetween&quot;:16&#125;&#125;&#125;">
<div className="swiper-wrapper">
...
<p className="fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span></p>
</div>
<div>
...
<p className="fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></p>
</div>
<div>
...
<p className="fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star-half-alt star-icon text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></p>
</div>
<div>
...
<div>
<div className="border border-1 border-translucent rounded-3 position-relative mb-3"><button className="btn btn-wish btn-wish-primary z-2 d-toggle-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist"><span className="fas fa-heart d-block-hover" data-fa-transform="down-1"></span><span className="far fa-heart d-none-hover" data-fa-transform="down-1"></span></button><img className="img-fluid" src="/site/assets/img/products/18.png" alt="" /></div><a className="stretched-link" href="/apps/e-commerce/landing/product-details">
<h6 className="mb-2 lh-sm line-clamp-3 product-name">Seagate Portable 2TB External Hard Drive Portable HDD</h6>
</a>
<p className="fs-9"><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa fa-star text-warning"></span><span className="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></p>
</div>
<div>
...
<div className="col-auto"><img className="d-dark-none" src="/site/assets/img/spot-illustrations/light_30.png" alt="" width="305" /><img className="d-light-none" src="/site/assets/img/spot-illustrations/dark_30.png" alt="" width="305" /></div>
<div className="col-auto">
<div className="text-center text-lg-start">
<h3 className="text-body-highlight mb-2"><span className="fw-semibold">Want to have the </span>ultimate <br className="d-md-none" /></h3>
<h1 className="display-3 fw-semibold mb-4">Become a <span className="text-primary fw-bolder">member </span>today!</h1><a className="btn btn-lg btn-primary px-7" href="/pages/authentication/simple/sign-up">Sign up<span className="fas fa-chevron-right ms-2 fs-9"></span></a>
</div>
</div>
</div>
</div>
...
<p className="mb-0 mt-2 mt-sm-0 text-body">Thank you for creating with Phoenix<span className="d-none d-sm-inline-block"></span><span className="d-none d-sm-inline-block mx-1">|</span><br className="d-sm-none" /></p>
</div>
<div className="col-12 col-sm-auto text-center">
