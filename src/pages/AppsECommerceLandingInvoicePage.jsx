...
export default function AppsECommerceLandingInvoicePage() {
  return (
    <>
...
<div><button className="btn btn-phoenix-secondary me-2"><span className="fa-solid fa-download me-sm-2"></span><span className="d-none d-sm-inline-block">Download Invoice</span></button>
<button className="btn btn-phoenix-secondary"><span className="fa-solid fa-print me-sm-2"></span><span className="d-none d-sm-inline-block">Print</span></button>
</div>
</div>
...
<th scope="col" style={{minWidth: "60px"}}>SL NO.</th>
<th scope="col" style={{minWidth: "360px"}}>Products</th>
<th className="ps-5" scope="col" style={{minWidth: "150px"}}>Color</th>
<th scope="col" style={{width: "60px"}}>Size</th>
<th className="text-end" scope="col" style={{width: "80px"}}>Quantity</th>
<th className="text-end" scope="col" style={{width: "100px"}}>Price</th>
<th className="text-end" scope="col" style={{width: "138px"}}>Tax Rate</th>
<th className="text-center" scope="col" style={{width: "80px"}}>Tax Type</th>
<th className="text-end" scope="col" style={{minWidth: "92px"}}>Tax</th>
<th className="text-end" scope="col" style={{minWidth: "60px"}}>Total</th>
<th scope="col" style={{width: "24px"}}></th>
</tr>
</thead>
<tbody>
...
<div className="text-end py-9 border-bottom"><img className="mb-3" src="/site/assets/img/logos/phoenix-mart.png" alt="" />
...
<div className="d-flex justify-content-between"><button className="btn btn-primary"><span className="fa-solid fa-bag-shopping me-2"></span>Browse more items</button>
<div><button className="btn btn-phoenix-secondary me-2"><span className="fa-solid fa-download me-sm-2"></span><span className="d-none d-sm-inline-block">Download Invoice</span></button>
<button className="btn btn-phoenix-secondary"><span className="fa-solid fa-print me-sm-2"></span><span className="d-none d-sm-inline-block">Print</span></button>
</div>
</div>
