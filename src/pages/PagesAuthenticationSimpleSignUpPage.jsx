...
export default function PagesAuthenticationSimpleSignUpPage() {
  return (
    <>
...
<div className="text-center"><a className="fs-9 fw-bold" href="/pages/authentication/simple/sign-in">Sign in to an existing account</a></div>
</form>
</div>
</div>
</div>
