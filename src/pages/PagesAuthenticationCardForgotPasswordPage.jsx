...
export default function PagesAuthenticationCardForgotPasswordPage() {
  return (
    <>
...
<div className="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-5"><img className="auth-title-box-img d-dark-none" src="/site/assets/img/spot-illustrations/auth.png" alt="" /><img className="auth-title-box-img d-light-none" src="/site/assets/img/spot-illustrations/auth-dark.png" alt="" /></div>
</div>
...
<form className="d-flex align-items-center mb-5"><input className="form-control flex-1" id="email" type="email" placeholder="Email" /><button className="btn btn-primary ms-2">Send<span className="fas fa-chevron-right ms-2"></span></button></form><a className="fs-9 fw-bold" href="#!">Still having problems?</a>
</div>
</div>
</div>
</div>
