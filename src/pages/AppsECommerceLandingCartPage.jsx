...
export default function AppsECommerceLandingCartPage() {
  return (
    <>
...
<th className="sort white-space-nowrap align-middle" scope="col" style={{minWidth: "250px"}}>PRODUCTS</th>
<th className="sort align-middle" scope="col" style={{width: "80px"}}>COLOR</th>
<th className="sort align-middle" scope="col" style={{width: "150px"}}>SIZE</th>
<th className="sort align-middle text-end" scope="col" style={{width: "300px"}}>PRICE</th>
<th className="sort align-middle ps-5" scope="col" style={{width: "200px"}}>QUANTITY</th>
<th className="sort align-middle text-end" scope="col" style={{width: "250px"}}>TOTAL</th>
...
<td className="products align-middle"><a className="fw-semibold mb-0 line-clamp-2" href="/apps/e-commerce/landing/product-details">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management & Skin Temperature Trends, Carbon/Graphite, One Size (S & L Bands)</a></td>
...
<div className="input-group input-group-sm flex-nowrap" data-quantity="data-quantity"><button className="btn btn-sm px-2" data-type="minus">-</button><input className="form-control text-center input-spin-none bg-transparent border-0 px-0" type="number" min="1" value="2" aria-label="Amount (to the nearest dollar)" /><button className="btn btn-sm px-2" data-type="plus">+</button></div>
</td>
<td className="total align-middle fw-bold text-body-highlight text-end">$398</td>
<td className="align-middle white-space-nowrap text-end pe-0 ps-3"><button className="btn btn-sm text-body-tertiary text-opacity-85 text-body-tertiary-hover me-2"><span className="fas fa-trash"></span></button></td>
</tr>
<tr className="cart-table-row btn-reveal-trigger">
...
<td className="products align-middle"><a className="fw-semibold mb-0 line-clamp-2" href="/apps/e-commerce/landing/product-details">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
<td className="color align-middle white-space-nowrap fs-9 text-body">Glossy black</td>
<td className="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">XL</td>
...
<td className="products align-middle"><a className="fw-semibold mb-0 line-clamp-2" href="/apps/e-commerce/landing/product-details">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
...
</div><button className="btn btn-primary w-100">Proceed to check out<span className="fas fa-chevron-right ms-1 fs-10"></span></button>
</div>
</div>
</div>
</div>
